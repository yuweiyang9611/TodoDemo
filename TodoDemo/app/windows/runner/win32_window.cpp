...
// static
LRESULT CALLBACK Win32Window::WndProc(const HWND window,
                                      const UINT message,
                                      const WPARAM wparam,
...
Win32Window* Win32Window::GetThisFromHandle(const HWND window) noexcept
{
...
void Win32Window::UpdateTheme(const HWND window)
{
    DWORD light_mode;
